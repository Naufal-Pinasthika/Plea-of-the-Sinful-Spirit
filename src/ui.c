			...
			unsigned int interval_ms, double elapsed_seconds)
{
	...
	printf("+-----+-------------+-------------+-------------+-------------+-------------+-------------+-------------+\n");
	printf("| CPU |  Syscalls/s |  Syscall Δ  | Context Δ   | ContextSw/s | PageFault/s |   Limited/s |     Drops/s |\n");
	printf("+-----+-------------+-------------+-------------+-------------+-------------+-------------+-------------+\n");
	for (cpu = 0; cpu < nr_cpus; cpu++) {
		printf("| %3d | %11.0f | %11llu | %11llu | %11.0f | %11.0f | %11.0f | %11.0f |\n",
		       cpu, rates[cpu].syscalls, rates[cpu].syscall_delta,
		       rates[cpu].context_switch_delta,
	...
	printf("+-----+-------------+-------------+-------------+-------------+-------------+-------------+-------------+\n");
	printf("| ALL | %11.0f | %11llu | %11llu | %11.0f | %11.0f | %11.0f | %11.0f |\n",
	       total.syscalls, total.syscall_delta, total.context_switch_delta,
	       total.context_switches, total.page_faults, total.rate_limited,
	       total.ringbuf_drops);
	printf("+-----+-------------+-------------+-------------+-------------+-------------+-------------+-------------+\n");
	fflush(stdout);
}
